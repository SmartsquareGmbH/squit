...
class SquitPostProcessTaskJsonArrayProcessorsTest {
    ...
    @Test
    fun `post-processor adds element to json array response`() {
        ...
        Files.readAllBytes(call1Response).toString(Charsets.UTF_8) shouldContain "application/json"
    }
}
