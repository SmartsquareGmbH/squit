 ...
 *
 * @property contextPath The path of the context the test has been run in. This means the test path without the suite
 ...
 * @author Ruben Gees
 */
data class SquitResult(@Suppress("MemberVisibilityCanPrivate") val contextPath: Path,
                       @Suppress("MemberVisibilityCanPrivate") val suitePath: Path,
                       val testDirectoryPath: Path,
                       val result: String = "") {
